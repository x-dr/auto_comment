...
class SparkApi:
    # 初始化
    def __init__(self,spark_appid, spark_key,spark_secret, spark_url, domain) -> None:
        # spark_appid, spark_key,spark_secret, spark_url, domain
        self.APPID = spark_appid
        self.APIKey =spark_key
        self.APISecret = spark_secret
